export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://vic.so/t/we-only-need-mcps-because-we-dont-trust-llms/opengraph-image',
        width: 1200,
        height: 630,
        alt: "We Only Need MCPs Because We Don't Trust LLMs",
      },
    ],
    siteName: 'Victor A.',
    locale: 'en_US',
  ...
  twitter: {
    ...
    description:
      'MCPs make sense when models are untrusted, but long-term safety should come from sandboxed environments and scoped access.',
    images: [
      'https://vic.so/t/we-only-need-mcps-because-we-dont-trust-llms/opengraph-image',
    ],
  },
};
