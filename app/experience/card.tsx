...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={tw("border-b border-foregorund/80", className)}
      {...props}
    />
  ),
)
...
const CardHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={tw("flex flex-col space-y-1.5 py-2", className)}
      {...props}
    />
  ),
)
...
>(({ className, ...props }, ref) => (
  <div ref={ref} className={tw("py-6", className)} {...props} />
))
