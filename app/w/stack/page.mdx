...
For forms, I use React 19 features like Server Actions and `useActionState`. I’ll also use Zod to validate objects inside my actions. [Here's one example](https://github.com/csvictor/next-saas-starter) of this pattern.
...
Postgres is my go-to database. Drizzle makes working with Postgres easy, type-safe, and fun. I can view and modify my data using Drizzle Studio and [run migrations](https://github.com/cs50victor/next-saas-starter) with Drizzle Kit.
...
- [Colocate code](https://x.com/vic8or) that changes often close together
